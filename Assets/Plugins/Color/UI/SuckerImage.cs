...
namespace SpringGUI
{
    public class SuckerImage : MaskableGraphic
    {
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            vh.AddUIVertexQuad(GetQuad(c , d , i , j , Color.white));
            vh.AddUIVertexQuad(GetQuad(e , f , g , h , Color.white));
            vh.AddUIVertexQuad(GetQuad(a , b , Color.white , 1));
            vh.AddUIVertexQuad(GetQuad(o , a , Color.white , 1));
            vh.AddUIVertexQuad(GetQuad(k , l , Color.white , 1));
            vh.AddUIVertexQuad(GetQuad(o , l , Color.white , 1));
            ...
            vh.AddUIVertexQuad(GetQuad(first , four , third , second , Color.white));
            ...
            vh.AddUIVertexQuad(GetQuad(first0 , second0 , third0 , four0 , Color.white));
            ...
            vh.AddUIVertexQuad(GetQuad(first1 , third1 , second1 , four1 , Color.white));
        }
